                        ...
                        <div class="relative z-10">
                            ...
                            <div class="pb-12 lg:hidden">
                                <div class="flex justify-center">
                                    <a class="social-link" href="{{ $options_page->acf_options['facebook'] }}"
                                        target="_blank">
                                        <svg class="social-dd" xmlns="http://www.w3.org/2000/svg"
                                            viewBox="0 0 430.11 430.11" height="1px" width="1px">
                                            <path
                                    ...
                                    <a class="social-link" href="{{ $options_page->acf_options['instagram'] }}"
                                        target="_blank">
                                        <svg class="social-dd" height="1px" width="1px" viewBox="0 0 24 24"
                                            xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <a class="social-link" href="{{ $options_page->acf_options['twitter'] }}"
                                        target="_blank">
                                        <svg class="social-dd" height="1px" width="1px" viewBox="0 0 24 24"
                                            xmlns="http://www.w3.org/2000/svg">
