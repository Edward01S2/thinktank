...
@section('content')
    ...
    @if (count($get_admin) > 0)
        <section id="admin" class="relative z-20 -mt-6 overflow-hidden md:-mt-16 lg:-mt-32 xl:-mt-48">
            <div class="relative h-16 rounded-top w-curve w-margin bg-tt-sand md:block md:z-20 md:h-24 lg:h-32 xl:h-64">
            </div>
    ...
    <section id="therapist" class="relative z-20 overflow-hidden md:pt-12 lg:pt-0">
