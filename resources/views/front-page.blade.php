...
@section('content')
  ...
  <section id="touch" class="bg-tt-darkblue relative">
    <div class="absolute w-full h-full z-0 opacity-05" style="background-image: url('{{$acf_options->background_image->url}}'); background-size:cover;"></div>
    <div class="relative z-10 flex flex-col text-center text-tt-sand px-8 py-8 md:py-16 lg:max-w-3xl lg:mx-auto">
      ...
      <div class="text-tt-darkblue">
        @php
          //echo $team->form->id;
        gravity_form_enqueue_scripts($acf_options->form->id, true);
        gravity_form($acf_options->form->id, false, false, false, '', true, 1); 
        @endphp
      </div>
    </div>
  </section>
