<footer class="content-info bg-tt-gray">
  <div class="container mx-auto">
    <div class="flex flex-col text-tt-sand items-center py-8 px-4 lg:px-8 lg:py-4 lg:flex-row lg:flex-wrap lg:justify-between xl:px-0">
      <div class="text-center pb-4 lg:text-left lg:pb-0 xl:flex">
        ...
        <div class="pb-4 xl:pl-8 lg:pb-0">
          <a class="underline italic" href="tel:{{$acf_options->phone}}">{{$acf_options->phone}}</a>
        </div>
      </div>
